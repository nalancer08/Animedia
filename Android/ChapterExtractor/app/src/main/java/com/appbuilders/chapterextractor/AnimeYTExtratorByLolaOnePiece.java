...
public class AnimeYTExtratorByLolaOnePiece extends AppCompatActivity {

    private int lolaId = 1025;
    private int startChapter = 710;
    private int lastChapter = 815;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.chapters = this.getResources().getStringArray(R.array.one_piece_chapters);
