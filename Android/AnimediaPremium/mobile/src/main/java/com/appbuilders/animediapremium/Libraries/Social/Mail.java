package com.appbuilders.animediapremium.Libraries.Social;
...
public final class Mail {
    ...
    private Mail(@NonNull Context context) {
     ...
     */
    public static Mail from(@NonNull Context context) {
     ...
     */
    public Mail to(@NonNull String to) {
        checkEmail(to);
        this.to.add(to);
        return this;
    }
     ...
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    public Mail to(@NonNull Collection<String> to) {
        checkNotNull(to);
        for (String email : to) {
            checkEmail(email);
        }
     ...
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    public Mail cc(@NonNull String cc) {
        checkEmail(cc);
        this.cc.add(cc);
        return this;
    }
     ...
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    public Mail cc(@NonNull Collection<String> cc) {
        checkNotNull(cc);
        for (String email : cc) {
            checkEmail(email);
        }
     ...
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    public Mail bcc(@NonNull String bcc) {
        checkEmail(bcc);
        this.bcc.add(bcc);
        return this;
    }
     ...
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    public Mail bcc(@NonNull Collection<String> bcc) {
        checkNotNull(bcc);
     ...
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    public Mail subject(@NonNull String subject) {
     ...
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    public Mail body(@NonNull String body) {
        checkNotNull(body);
