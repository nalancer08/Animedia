...
import com.appbuilders.animediapremium.Implement.IUserMethods;
import com.appbuilders.animediapremium.Implement.Util;
...
public class EasyClickableVideoPlayer extends FrameLayout implements IUserMethods, TextureView.SurfaceTextureListener,
    ...
    public EasyClickableVideoPlayer(Context context) {
        super(context);
        init(context, null);
    }

    public EasyClickableVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EasyClickableVideoPlayer(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(
                    attrs,
                    com.afollestad.easyvideoplayer.R.styleable.EasyVideoPlayer,
                    0, 0);
            try {
                ...
                int restartDrawableResId = a.getResourceId(com.afollestad.easyvideoplayer.R.styleable.EasyVideoPlayer_evp_restartDrawable, -1);
                ...
                mHideControlsOnPlay = a.getBoolean(com.afollestad.easyvideoplayer.R.styleable.EasyVideoPlayer_evp_hideControlsOnPlay, true);
                ...
                mThemeColor = a.getColor(com.afollestad.easyvideoplayer.R.styleable.EasyVideoPlayer_evp_themeColor,
    ...
    @Override
    public void setLeftAction(@EasyVideoPlayer.LeftAction int action) {
    ...
    @Override
    public void setRightAction(@EasyVideoPlayer.RightAction int action) {
    ...
    protected void onFinishInflate() {
        ...
        ((FrameLayout) mClickFrame).setForeground(Util.resolveDrawable(getContext(), com.afollestad.easyvideoplayer.R.attr.selectableItemBackground));
